  ...
  return (
    <div className="ats-modal-bg" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="ats-modal">
        ...
        {/* Job Role Detected */}
        {result.jobRole && (
          <div style={{ textAlign: 'center', fontSize: '.82rem', color: '#6b7280', marginBottom: '.5rem' }}>
            Analyzed for: <strong style={{ color: '#1a1f36' }}>{result.jobRole}</strong>
          </div>
        )}

        {/* Summary */}
        <p style={{ textAlign: 'center', fontSize: '.88rem', color: '#374151', marginBottom: '1.25rem', lineHeight: 1.6 }}>
          {result.summary}
        </p>

        {/* Keyword Analysis */}
        {kw.expectedKeywords && (
          <div style={{ marginBottom: '1.25rem', background: '#f8faff', border: '1px solid #e0e7ff', borderRadius: 10, padding: '1rem' }}>
            <h4 style={{ fontSize: '.82rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.5px', color: '#4338ca', marginBottom: '.75rem' }}>
              🔍 Keyword Analysis
            </h4>

            {/* Found Keywords */}
            {kw.foundKeywords?.length > 0 && (
              <div style={{ marginBottom: '.6rem' }}>
                <div style={{ fontSize: '.75rem', fontWeight: 600, color: '#16a34a', marginBottom: '.3rem' }}>✓ Found in Resume</div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '.3rem' }}>
                  {kw.foundKeywords.map((k, i) => (
                    <span key={i} style={{ background: '#dcfce7', color: '#15803d', padding: '2px 8px', borderRadius: 12, fontSize: '.75rem', fontWeight: 500 }}>{k}</span>
                  ))}
                </div>
              </div>
            )}
            ...
            {kw.missingKeywords?.length > 0 && (
              <div>
                <div style={{ fontSize: '.75rem', fontWeight: 600, color: '#dc2626', marginBottom: '.3rem' }}>✕ Missing — Add These</div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '.3rem' }}>
                  {kw.missingKeywords.map((k, i) => (
                    <span key={i} style={{ background: '#fee2e2', color: '#b91c1c', padding: '2px 8px', borderRadius: 12, fontSize: '.75rem', fontWeight: 500 }}>{k}</span>
                  ))}
                </div>
              </div>
            )}
        ...
        {result.improvements?.length > 0 && (
          <div>
            <h4 style={{ fontSize: '.82rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.5px', color: '#6b7280', marginBottom: '.75rem' }}>
...
export default function BuilderPage() {
  ...
  // Form state
  const [personalInfo, setPersonalInfo] = useState({ name: '', jobTitle: '', email: '', phone: '', location: '', website: '', summary: '' });
  ...
  const resumeData = { personalInfo, experience, education, skills, tools, projects };
      ...
      <>
        ...
        <div className="page-wrap">
          <div style={{ maxWidth: 700, margin: '0 auto' }}>
            ...
            <p className="section-sub">Both templates are professional, ATS-friendly, and free</p>
                ...
                },
                {
                  id: 'vertical', label: 'Vertical', sub: 'Sidebar left · Main right', svg: (
                    <svg width="150" height="115" viewBox="0 0 150 115">
                      ...
                      <rect x="9" y="73" width="18" height="2" rx="1" fill="#c9a84c" />
                      <rect x="9" y="78" width="22" height="2.5" rx="1" fill="#c9a84c" />
                      <rect x="9" y="83" width="18" height="2.5" rx="1" fill="#c9a84c" />
                      ...
                      <rect x="56" y="44" width="68" height="2" rx="1" fill="#e5e7eb" />
                      <rect x="56" y="57" width="42" height="3" rx="1" fill="#1a1f36" />
                      <rect x="56" y="63" width="75" height="2" rx="1" fill="#e5e7eb" />
                      <rect x="56" y="68" width="58" height="2" rx="1" fill="#e5e7eb" />
                    </svg>
                  )
                },
              ].map(t => (
          ...
          <div className="form-panel">
            ...
            <div className="row-2">
              ...
              <div className="form-group">
                ...
                <input type="text" placeholder="linkedin.com/in/aravind"
              ...
              <div className="form-group">
                ...
                <input type="text" placeholder="aravind.dev or github.com/aravind"
              ...
              <div className="entry-block" key={i}>
                ...
                <div className="row-2">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" placeholder="github.com/project or live-demo.com"
                      value={exp.projectLink || ''}
                      onChange={e => updateExp(i, 'projectLink', e.target.value)} />
                  </div>
            ...
            <div className="form-group" style={{ marginTop: '.5rem' }}>
              ...
              <input type="text" placeholder="React, Node.js, MongoDB, Express, Python, Git"
                value={skillsInput}
                onChange={e => setSkillsInput(e.target.value)} />
            </div>
            <div className="form-group">
              <label>Tools <span style={{ color: '#9ca3af', fontWeight: 400 }}>(comma separated)</span></label>
              <input type="text" placeholder="VS Code, Postman, Azure, Git, Docker, Figma"
                value={toolsInput}
          ...
          <div className="preview-sticky">
            ...
            <div className="preview-body">
              <div style={{ transform: 'scale(0.42)', transformOrigin: 'top left', width: '238%' }}>
                {template === 'vertical'
                  ? <VerticalTemplate data={resumeData} />
